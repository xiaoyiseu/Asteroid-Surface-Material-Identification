...
class Unet1(object):
    _defaults = {
        ...
        "model_path"    : 'model_data/ep050-loss0.036-val_loss0.006.pth',
        #--------------------------------#
        #   所需要区分的类的个数+1
        #--------------------------------#
        "num_classes"   : 4,
    ...
    def detect_image(self, image):
        ...
        if self.blend:
            ...
            # image.save(r'E:\Trans\Experiment 1 semantic segmentation\3.unet-pytorch-main\img_out\\1.jpg')
